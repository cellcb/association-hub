import { Search, Filter, Plus, MoreVertical, CheckCircle, XCircle, Clock, Edit, Trash2, Eye, X, FileText, User, Calendar, Tag, Loader2, ImageIcon, Upload } from 'lucide-react';
      ...
      {value ? (
        <div className="relative inline-block">
          <img
            src={value}
            alt="封面预览"
            className="max-w-[300px] max-h-[200px] rounded-lg border border-gray-200 object-cover"
          />
          <button
            type="button"
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-400 transition-colors">
          ...
          <p className="text-sm text-gray-600 mb-3">点击或拖拽上传封面图片</p>
      ...
      <div className="flex gap-2">
        <label className="flex-1">
          <input
            ...
            className="hidden"
          />
          <span className={`flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-sm cursor-pointer hover:bg-gray-50 transition-colors ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}>
            {uploading ? (
              <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <CoverImageUpload
                    ...
                    onChange={(url) => onFormChange({ target: { name: 'coverImage', value: url } })}
                  />
                </div>
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <img
                  src={news.coverImage}
                  alt="封面图片"
                  className="max-w-full max-h-[300px] rounded-lg border border-gray-200 object-cover"
                />
              </div>
            </div>
          )}
